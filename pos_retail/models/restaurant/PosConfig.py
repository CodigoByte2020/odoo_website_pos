...
class PosConfig(models.Model):
    ...
    point_print = fields.Boolean(
        'Point Print Kitchen Bill',
        help='All waiters submit order to kitchen will send this point for print kitchen bill'
    )
