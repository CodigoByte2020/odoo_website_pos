...
odoo.define('pos_retail.load_models', function (require) {
    ...
    models.load_models([{
        ...
        model: 'product.college', fields: ['name', 'code'], loaded: function (self, colleges) {
            self.product_colleges = colleges;
        }
    }, {
        model: 'product.model', fields: ['name', 'code'], loaded: function (self, models) {
            self.product_models = models;
        }
    }, {
        model: 'product.sex', fields: ['name', 'code'], loaded: function (self, sexes) {
    ...
    models.load_models([{
        model: 'pos.epson', fields: ['name', 'ip'], loaded: function (self, epson_printers) {
        ...
        model: 'pos.service.charge', fields: ['name', 'product_id', 'type', 'amount'], condition: function (self) {
            return self.config.service_charge_ids && self.config.service_charge_ids.length;
        }, domain: function (self) {
            return [['id', 'in', self.config.service_charge_ids],]
        ...
        model: 'pos.product.default.new.cart', fields: ['name', 'product_id', 'quantity'], condition: function (self) {
            return self.config.product_default_ids && self.config.product_default_ids.length
        }, domain: function (self) {
            return [['id', 'in', self.config.product_default_ids]]
        }, loaded: function (self, products_default_new_cart) {
            self.products_default_new_cart = products_default_new_cart
        }
    }, {
        model: 'res.bank', fields: ['name'], loaded: function (self, banks) {
            self.banks = banks;
            self.bank_by_id = {};
        ...
        model: 'res.lang', fields: [], loaded: function (self, langs) {
            self.langs = langs
            self.lang_selected = langs.find(l => l.code == self.user.lang)
        }
    }, {
        model: 'gift.card', fields: [], condition: function (self) {
        ...
        model: 'pos.promotion',
        fields: ['name', 'start_date', 'end_date', 'type', 'product_id', 'discount_lowest_price', 'product_ids', 'minimum_items', 'discount_first_order', 'special_customer_ids', 'promotion_birthday', 'promotion_birthday_type', 'promotion_group', 'promotion_group_ids', 'pos_branch_ids', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'from_time', 'to_time', 'special_days', 'special_times', 'method', 'amount_total'],
        domain: function (self) {
            let domains = [['state', '=', 'active'], ['id', 'in', self.config.promotion_ids]];
            return domains
        },
        promotion: true,
        ...
        domain: function (self) {
            return [['id', '=', self.config.pos_loyalty_id[0]], ['state', '=', 'running'],]
        },
        ...
        fields: ['name', 'loyalty_id', 'coefficient', 'type', 'product_ids', 'category_ids', 'min_amount'],
        condition: function (self) {
        ...
        fields: ['name', 'loyalty_id', 'redeem_point', 'type', 'coefficient', 'discount', 'discount_product_ids', 'discount_category_ids', 'min_amount', 'gift_product_ids', 'resale_product_ids', 'gift_quantity', 'price_resale'],
        condition: function (self) {
        ...
        fields: ['name', 'barcode', 'list_price', 'product_id', 'qty', 'sequence', 'pack_uom_id'],
        domain: function (self) {
            return [['active', '=', true]]
        },
    ...
    let extend_models = [{
        label: 'Multi Currency', model: 'res.currency', fields: [], domain: function (self) {
            return [['active', '=', true]]
        ...
        label: 'Units of Measure', model: 'uom.uom', fields: [], domain: [], loaded: function (self, uoms) {
            self.uom_by_id = {};
        ...
        model: 'pos.tag', fields: ['name', 'is_return_reason', 'color'], domain: [], loaded: function (self, tags) {
            self.tags = tags;
            self.tag_by_id = {};
            self.cancel_reasons = []
            self.return_reasons = [];
        ...
        model: 'pos.note', fields: ['name'], loaded: function (self, notes) {
            self.notes = notes;
            self.note_by_id = {};
            let i = 0;
        ...
        model: 'product.generic.option', fields: ['product_ids', 'name', 'price_extra'], condition: function (self) {
            return self.config.product_generic_option;
        }, domain: [], loaded: function (self, generic_options) {
        ...
        model: 'pos.config', fields: [], domain: function (self) {
            return []
        ...
        label: 'Product Price by Quantity', model: 'product.price.quantity', // product price quantity
        fields: ['quantity', 'price_unit', 'product_tmpl_id'], loaded: function (self, records) {
        ...
        label: 'Partner Titles', model: 'res.partner.title', condition: function (self) {
            return !self.config.hide_title
        }, fields: ['name'], loaded: function (self, partner_titles) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        get_units_barcode_by_id: function (product_id) {
            ...
            let self = this;
            return rpc.query({
                model: 'pos.backup.orders', method: 'getUnpaidOrders', args: [[], {
            ...
            return rpc.query({
                model: 'pos.backup.orders', method: 'automaticBackupUnpaidOrders', args: [[], {
                    config_id: this.config.id, unpaid_orders: unpaidOrders, total_orders: unpaidOrders.length
                }]
            }, {
                shadow: true, timeout: 60000
        ...
        polling_job_auto_paid_orders_draft: function () {
            let self = this;
            let params = {
                message: 'Automatic Paid Orders Draft have full fill payment', config_id: this.config.id
            };
            ...
            return _super_PosModel.load_server_data.apply(this, arguments).then(function () {
                ...
                let records = self.rpc({
                    model: 'hr.employee', method: 'get_barcodes_and_pin_hashed', args: [employee_ids],
                });
