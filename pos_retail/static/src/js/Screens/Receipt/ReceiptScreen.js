    ...
    const RetailReceiptScreen = (ReceiptScreen) =>
        class extends ReceiptScreen {
            ...
            async printReceipt() {
                ...
                // --------------------------------------------------
                // if (this.env.pos.proxy.printer && this.env.pos.config.proxy_ip && this.currentOrder) {
                //     const report_xml = qweb.render('XmlReceipt', this.currentOrder.get_receipt_render_env())
